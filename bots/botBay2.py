...
class Player(BaseBot):
    ...
    def compute_equity(self, my_cards, board, base_iters=150):
        ...
        board_eval = [eval7.Card(c) for c in board]
        used_strs = set(str(c) for c in my_eval + board_eval)
        ...
        for opp_combo in opp_samples:
            ...
            if str(opp_cards[0]) in used_strs or str(opp_cards[1]) in used_strs:
                continue
    ...
    def get_move(self, game_info: GameInfo, current_state: PokerState):
        ...
        pot_odds = cost / (pot + cost) if pot + cost > 0 else 0
        spr = min(current_state.my_chips, current_state.opp_chips) / pot if pot > 0 else 10
